...
- Phase 5: in progress (plan title persistence, milestone creation/completion workflow, resources API, and resources workspace UI replacing placeholder pages).
